...
from MambaIR.basicsr.utils.registry import LOSS_REGISTRY
...
class GANLoss(torch.nn.Module):
    ...
    def _wgan_softplus_loss(self, input, target):
        ...
        Returns:
            Tensor: wgan loss.
        """
        return torch.nn.functional.softplus(-input).mean() if target else torch.nn.functional.softplus(input).mean()
...
@LOSS_REGISTRY.register()
class GANFeatLoss(torch.nn.Module):
